...
mod bool_logic_macro_test {
    ...
    //     assert_eq!(bool!(!(a && c) && b), And(Not(And(true, false)), false));
    //     assert_eq!(bool!(!((a && c) && b)), Not(And(And(true, false),
    // false)));     assert_eq!(bool!(!(a && (a && b))), Not(And(true,
    // And(true, false))));     assert_eq!(
    //         bool!(!((a && b) && (a && b))),
    ...
    //     assert_eq!(bool!(!(a || c) || b), Or(Not(Or(true, false)), false));
    //     assert_eq!(bool!(!((a || c) || b)), Not(Or(Or(true, false), false)));
    //     assert_eq!(bool!(!(a || (a || b))), Not(Or(true, Or(true, false))));
    //     assert_eq!(
    //         bool!(!((a || b) || (a || b))),
    ...
    //
    //     bool!(a);
    //     // assert_eq!(bool!(a), a.expr()); // meet error:
    //     //     assert_eq!(bool!(!a), (!a).expr());
    //     //     |         ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    //     //     |         |
    //     //     |         Expression<_>
